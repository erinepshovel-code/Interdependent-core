...
from prime_core.invariants import TENSOR_SHAPE
...
def exchange_score(
    *,
    ...
    """Canon C6 scalar exchange score.

    Thin wrapper around :func:`compute_score` that returns only the
    scalar. Callers needing the per-channel component breakdown should
    call :func:`compute_score` directly.
    """
    score, _components = compute_score(
